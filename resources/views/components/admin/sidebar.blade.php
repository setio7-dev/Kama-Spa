    ...
    <li class="nav-item {{ request()->is('admin/kas-kecil*') ? 'active' : '' }}">
      ...
      <div class="collapse" id="error">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a
              class="nav-link {{ request()->path() == 'admin/kas-kecil/pengajuan-kas' ? 'active' : '' }}"
              href="{{ route('adminPengajuan') }}">Req Pengajuan Kas</a></li>
          <li class="nav-item"> <a
              class="nav-link {{ request()->path() == 'admin/kas-kecil/pengelolaan-kas' ? 'active' : '' }}"
              href="{{ route('adminPengelolaan') }}">Pengelolaan Kas</a></li>
        </ul>
      </div>
    </li>
